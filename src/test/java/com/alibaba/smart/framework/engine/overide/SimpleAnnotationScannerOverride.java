...
public class SimpleAnnotationScannerOverride implements AnnotationScanner {

    public static final String JAR = "jar";
    public static final String FILE = "file";
    public static final String UTF_8 = "UTF-8";

    private static final Logger LOGGER = LoggerFactory.getLogger(SimpleAnnotationScannerOverride.class);


    @Override
    public Map<String, ExtensionBindingResult> getScanResult() {
        return scanResult;
    }
    ...
    public SimpleAnnotationScannerOverride(String... packageNameList) {this.packageNameList = packageNameList;}
